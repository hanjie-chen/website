...
TRANSLATIONS = {
    "zh": {
        ...
        "home.start.briefs_empty": "每日筛选的 AI、开发工具与 Hacker News 热门信息即将发布。",
        "home.start.briefs_archive": "查看简报入口 →",
        ...
        "briefs.page.description": "每天筛选少量值得阅读的 AI、开发工具与 Hacker News 热门内容，减少信息噪声。",
        "briefs.language_note": "Daily Brief 正文目前仅提供中文。",
        "briefs.latest.title": "最新一期",
        "briefs.archive.title": "历史归档",
        "briefs.items": "条内容",
        "briefs.editions": "期",
        "briefs.open": "打开简报 →",
        "briefs.empty.title": "第一期简报尚未发布",
        "briefs.empty.description": "Daily Brief 发布后会出现在这里。",
        "briefs.back": "返回简报归档",
        "briefs.detail.description": "AI 与开发工具相关内容，以及少量兴趣范围之外的重要热门话题。",
        "briefs.detail.summary": "本期内容概览",
        "briefs.detail.ai_items": "条 AI 与开发工具",
        "briefs.detail.non_ai_items": "条圈外热门",
        "briefs.section.ai": "AI 与开发工具",
    ...
    "en": {
        ...
        "home.start.briefs_empty": "A daily selection of AI, developer tooling, and Hacker News stories will appear here.",
        "home.start.briefs_archive": "Open Daily Brief →",
        ...
        "briefs.page.description": "A small daily selection of AI, developer tooling, and notable Hacker News stories, curated to reduce information noise.",
        "briefs.language_note": "Daily Brief entries are currently published in Chinese only.",
        "briefs.latest.title": "Latest Edition",
        "briefs.archive.title": "Archive",
        "briefs.items": "items",
        "briefs.editions": "editions",
        "briefs.open": "Open brief →",
        "briefs.empty.title": "The first brief has not been published yet",
        "briefs.empty.description": "Published Daily Brief editions will appear here.",
        "briefs.back": "Back to the archive",
        "briefs.detail.description": "AI and developer-tool stories, plus a small number of notable topics outside the usual focus area.",
        "briefs.detail.summary": "Edition summary",
        "briefs.detail.ai_items": "AI & tooling",
        "briefs.detail.non_ai_items": "beyond the bubble",
        "briefs.section.ai": "AI & developer tools",
